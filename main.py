...
print(f"The cargo vehicle is a semi-truck that takes {semi_truck_1.fuel}, has {semi_truck_1.miles} miles and requires"
      f" a service every {semi_truck_1.service_cycle}. This semi-truck has a maxload of: {semi_truck_1.maxload}LBS.")
...
print(f"This train is both a cargo and passenger vehicle that hauls {train_1.cargo_type} material and can carry"
      f"{train_1.number_of_passengers} split between its {train_1.number_of_cars} cars. The train has a max"
